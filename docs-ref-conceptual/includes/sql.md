<span data-ttu-id="d51a9-101">[Management API を使用して Azure SQL Database を構成する][1] </span><span class="sxs-lookup"><span data-stu-id="d51a9-101">[Configure Azure SQL Database with the management API][1] </span></span>  
